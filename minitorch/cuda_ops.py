...
def _tensor_matrix_multiply(
    ...
    Args:
    ----
        out (Storage): Output storage array
        out_shape (Shape): Shape of output tensor
        out_strides (Strides): Strides of output tensor
        out_size (int): Total size of output tensor
        a_storage (Storage): Storage array for first input tensor
        a_shape (Shape): Shape of first input tensor
        a_strides (Strides): Strides of first input tensor
        b_storage (Storage): Storage array for second input tensor
        b_shape (Shape): Shape of second input tensor
        b_strides (Strides): Strides of second input tensor
